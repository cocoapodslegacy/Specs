Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/cocoapodslegacy/NUIParse"
  s.description = 'A data-driven UICollectionView framework for building fast and flexible lists.'

  s.license =  { :type => 'MIT' }
  s.authors = 'tangji'

  s.source           = { :http => "https://cdn.jsdelivr.net/gh/cocoapodslegacy/#{s.name.to_s}@1.3_importUpdate/Framework/#{s.version.to_s}/#{s.name.to_s}.zip"}
